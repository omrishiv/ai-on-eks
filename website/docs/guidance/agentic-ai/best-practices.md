...
Or from model quality changes. This is a binary assertion — for more complex evaluation criteria,
see [Tracing and Evaluating Agents](./evaluating-agents.md).
...
- [Tracing and Evaluating Agents](./evaluating-agents.md) — Add LangFuse observability and set up evaluation pipelines
